...
public final class RingBufferWheelStudy {
     ...
     */
    public RingBufferWheelStudy(ExecutorService executorService) {
     ...
     */
    public RingBufferWheelStudy(ExecutorService executorService, int bufferSize) {
     ...
     * 
     * @param task
     *            business task extends RingBufferWheel.Task
     */
    ...
    /**
     * Start background thread to consumer wheel timer, it will always run until
     * you call method {@link #stop}
     */
    public void start() {
     ...
     * 
     * @param force
     *            True will force close consumer thread and discard all pending
     *            tasks otherwise the consumer thread waits for all tasks to
